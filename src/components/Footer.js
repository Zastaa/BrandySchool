  ...
  return (
    <footer id="Footer" className="bg-gray-900 text-gray-300 py-12 px-6 sm:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Info Sekolah */}
        <div>
          <h3 className="text-white text-xl font-bold mb-4">Brandly's</h3>
          <p className="text-sm leading-relaxed">
            Jalan Raya Cibinong No. 123, Bogor, Jawa Barat <br />
            Telepon: (0251) 1234567 <br />
            Email: info@Brandly's.sch.id
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm mb-2">Email: info@Brandly's.sch.id</p>
        ...
        <div>
          ...
          <div className="flex space-x-4 text-gray-400">
            <a href="https://facebook.com/Brandly's" aria-label="Facebook" className="hover:text-blue-600 transition">
            ...
            <a href="https://instagram.com/Brandly's" aria-label="Instagram" className="hover:text-pink-500 transition">
            ...
            <a href="https://twitter.com/Brandly's" aria-label="Twitter" className="hover:text-blue-400 transition">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24">
      ...
      <div className="mt-12 border-t border-gray-700 pt-6 text-center text-sm text-gray-500">
        © {new Date().getFullYear()} Brandly's. All Rights Reserved.
      </div>
    </footer>
  );
};
