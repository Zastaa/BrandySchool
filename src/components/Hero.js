    ...
    <section id='Hero' className="relative h-screen flex items-center justify-center text-center text-white overflow-hidden">
      ...
      <div className="relative z-10 p-4 max-w-4xl mx-auto">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-4 leading-tight drop-shadow-lg">
          Selamat Datang di <span className="text-blue-400">Brandy's</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          <a
            href="#pendaftaran"
            className="inline-block bg-blue-600 text-white font-semibold px-8 py-4 rounded-lg shadow-lg hover:bg-blue-700 transition duration-300 transform hover:scale-105"
          >
            Daftar Sekarang
          </a>
          <a
            href="#about"
            className="inline-block text-blue-300 font-semibold px-8 py-4 rounded-lg hover:underline transition duration-300"
          >
